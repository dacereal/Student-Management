<div>
    ...
    <div class="py-4">
        ...
        <div class="flex justify-between p-4 item-center">
               ...
               <div>
                <a href="{{ route('students.create') }}" wire:navigate class="inline-flex items-center px-4 py-3 mb-4 text-sm font-medium text-gray-700 bg-gray-200 border border-transparent rounded-lg shadow-md gap-x-2 hover:bg-gray-300 focus:outline-none focus:bg-gray-300 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:bg-gray-600">
                    Add Student
                </a>
               </div>
            </div>
            ...
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="my-4">
                        {{ $student->links(data: ['scrollTo' => false]) }}
                    </div>
                </div>
            </div>
        </div>
